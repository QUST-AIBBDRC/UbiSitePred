...
shu=scale(shu)
label=data[:,0]	
data_2,importance=elasticNet(shu,label)
shu=data_2
X=shu
y=label
sepscores = []
...
data_csv.to_csv(r'F:\项目1 ubiquitination泛素化\开源代码\code\svm1_elasticNet_yu.csv')
sio.savemat(r'F:\项目1 ubiquitination泛素化\开源代码\code\elasticNet1.mat', {'elasticNet':data_2}) 	