...
data_csv.to_csv(r'F:\项目1 ubiquitination泛素化\开源代码\code\svm1_selectFromExtraTrees_yu.csv')
sio.savemat(r'F:\项目1 ubiquitination泛素化\开源代码\code\selectFromExtraTrees1.mat', {'selectFromExtraTrees':data_2}) 
